...
We now provide a full justification for the conditioning step yielding equation (\ref{conditionalDistnFixed_f}) in Section \textcolor{blue}{\ref{general_framework}}. The justification essentially follows from Theorem 3.3 in \textcolor{blue}{\citep{owhadi2015conditioning}}. This theorem is given below (we only give the part of the theorem we require): \vspace{8pt}
...
\begin{equation*}
    ...
    \end{pmatrix}
\end{equation*}
We assume the invertibility of this partition. \vspace{8pt}
