...
\begin{align*}
    ...
    &\leq C_{1}h\|K\mathcal{L}^{-1}\|_{1}
\end{align*}
where we have used the fact that $\|S\|_{\infty}\leq1$. Since $B_{1}$ (and $B_{2}$) is invertible and for sufficiently small $h$ we have that $\|B_{1}-B_{2}\|_{\infty}<1/\|B_{1}^{-1}\|_{\infty}$
